  ...
  return (
    <div className="p-8">
      ...
      <table className="w-full border-collapse border border-gray-300">
        <thead>
          <tr className="bg-[#1A2230] p-4 rounded-lg border-white/5 border-2 text-white">
            <th className=""></th>
        ...
        <tbody className="">
          {heroes.map((hero) => (
            <tr key={hero.id} className="bg-[#1A2230] p-4 rounded-lg border-white/5 border-2 text-white">
              <td className="">
